...
void sendItAll()
{
  ...
  info[9] = bcount;
  char ps4s [7];
  info[10] = dtostrf(ps4,5,0,ps4s);;
  info[11] = ps5;
  info[12] = ps6;
  info[13] = accy;
    Serial.print("    ");
    Serial.print(info[13]);
  info[14] = accx;
    Serial.print("    ");
    Serial.print(info[14]);
  info[15] = cbut;
    Serial.print("    ");
    Serial.print(info[15]);
  info[16] = zbut;
    Serial.print("    ");
    Serial.print(info[16]);
  info[17] = joyx;
    Serial.print("    ");
    Serial.print(info[17]);
  info[18] = joyy;
    Serial.print("    ");
    Serial.print(info[18]);
    Serial.print("      ");
  vw_send(info, 19);
  vw_wait_tx();
