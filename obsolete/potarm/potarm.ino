...
void solveangles(double XX,double YY,double ZZ, double CL)
{
  ...
  //in the plane created by the arm
  double R = sqrt((r*r)+(ZZ*ZZ));
  //if(r<0) R*=-1;
  //if(ZZ<0) R*=-1;
    //Serial.print(R);  //4
    //Serial.print("     ");
