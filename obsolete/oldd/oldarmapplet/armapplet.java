...
/*<applet code="armapplet" width=1000 height=800></applet>*/
   	...
   	if(fact==-1) 
		...
		else if(fact >0);
		{
			...
			for(double j=0;j<b;j+=step)
			{
				...
				g.fillOval(275,770,20,20);
 				g.fillOval(275+(int)((3*bicep*Math.cos(a1))),770-(int)(3*bicep*Math.sin(a1)),20,20);
				g.fillRect(230,780,160,13); //System.out.println("after draw");
					/*try 
					{
    					Thread.sleep(1);
